  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative py-12 xs:py-16 sm:py-20">
        ...
        <div className="relative container mx-auto px-4 xs:px-6 text-center">
      ...
      {/* Our Mission Section */}
      <section className="py-8 xs:py-12 sm:py-16 px-4 xs:px-6 bg-white">
        <div className="container mx-auto">
          <div className="flex flex-col lg:flex-row items-center gap-6 xs:gap-8 sm:gap-12">
            ...
            <div className="w-full lg:w-1/2 relative h-64 xs:h-80 sm:h-96 md:h-[400px] lg:h-[500px] rounded-lg overflow-hidden shadow-xl">
              <Image 
      ...
      {/* Core Values */}
      <section className="py-8 xs:py-12 sm:py-16 px-4 xs:px-6 bg-gray-50">
        <div className="container mx-auto">
          <h2 className="text-xl xs:text-2xl sm:text-3xl font-bold text-gray-800 mb-6 xs:mb-8 sm:mb-10 text-center">Our Core Values</h2>
          
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 xs:gap-6 sm:gap-8">
            <div className="bg-white rounded-lg p-4 xs:p-6 sm:p-8 shadow-md hover:shadow-lg transition-shadow">
              <div className="w-12 h-12 xs:w-16 xs:h-16 bg-pink-100 rounded-full flex items-center justify-center mb-4 xs:mb-6 mx-auto">
                <FaCheckCircle className="text-pink-600 text-xl xs:text-2xl sm:text-3xl" />
              </div>
              <h3 className="text-base xs:text-lg sm:text-xl font-bold text-center mb-2 xs:mb-4">Quality First</h3>
            ...
            <div className="bg-white rounded-lg p-4 xs:p-6 sm:p-8 shadow-md hover:shadow-lg transition-shadow">
              <div className="w-12 h-12 xs:w-16 xs:h-16 bg-pink-100 rounded-full flex items-center justify-center mb-4 xs:mb-6 mx-auto">
                <FaLeaf className="text-pink-600 text-xl xs:text-2xl sm:text-3xl" />
              </div>
              <h3 className="text-base xs:text-lg sm:text-xl font-bold text-center mb-2 xs:mb-4">Sustainable Practices</h3>
              <p className="text-xs xs:text-sm sm:text-base text-gray-600 text-center">
            ...
            <div className="bg-white rounded-lg p-4 xs:p-6 sm:p-8 shadow-md hover:shadow-lg transition-shadow sm:col-span-2 md:col-span-1 sm:max-w-md sm:mx-auto sm:w-full">
              <div className="w-12 h-12 xs:w-16 xs:h-16 bg-pink-100 rounded-full flex items-center justify-center mb-4 xs:mb-6 mx-auto">
                <FaMapMarkerAlt className="text-pink-600 text-xl xs:text-2xl sm:text-3xl" />
              </div>
              <h3 className="text-base xs:text-lg sm:text-xl font-bold text-center mb-2 xs:mb-4">Ethical Production</h3>
              <p className="text-xs xs:text-sm sm:text-base text-gray-600 text-center">
      ...
      <section className="py-8 xs:py-12 sm:py-16 px-4 xs:px-6 bg-white">
        <div className="container mx-auto">
          <div className="flex flex-col lg:flex-row-reverse items-center gap-6 xs:gap-8 sm:gap-12">
            <div className="lg:w-1/2">
              ...
              <Link href="/contact" className="bg-pink-500 text-white px-4 xs:px-6 py-2 xs:py-3 rounded-md inline-block hover:bg-pink-600 transition-colors text-xs xs:text-sm sm:text-base">
                Join Our Team
              </Link>
            </div>
            <div className="w-full lg:w-1/2 relative h-64 xs:h-80 sm:h-96 md:h-[400px] lg:h-[500px] rounded-lg overflow-hidden shadow-xl">
      ...
      <section className="py-8 xs:py-12 sm:py-16 px-4 xs:px-6 bg-gray-50">
        <div className="container mx-auto">
          <h2 className="text-xl xs:text-2xl sm:text-3xl font-bold text-gray-800 mb-6 xs:mb-8 sm:mb-10 text-center">Our Sustainability Commitment</h2>
          
          <div className="mb-6 xs:mb-8 sm:mb-12">
            <div className="relative h-48 xs:h-64 sm:h-80 md:h-[400px] rounded-lg overflow-hidden shadow-xl mb-4 xs:mb-6 sm:mb-8">
              <Image 
              ...
              <div className="absolute bottom-0 left-0 p-4 xs:p-6 sm:p-8 text-white max-w-lg">
                <h3 className="text-lg xs:text-xl sm:text-2xl font-bold mb-1 xs:mb-2">Making Fashion Sustainable</h3>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 xs:gap-6 sm:gap-8">
            <div className="bg-white rounded-lg p-4 xs:p-5 sm:p-6 shadow-md hover:shadow-lg transition-shadow">
              <div className="w-10 h-10 xs:w-12 xs:h-12 bg-green-100 rounded-full flex items-center justify-center mb-3 xs:mb-4">
                <FaLeaf className="text-green-600 text-base xs:text-lg sm:text-xl" />
              </div>
              <h3 className="text-base xs:text-lg font-bold mb-2 xs:mb-3">Sustainable Materials</h3>
            ...
            <div className="bg-white rounded-lg p-4 xs:p-5 sm:p-6 shadow-md hover:shadow-lg transition-shadow">
              <div className="w-10 h-10 xs:w-12 xs:h-12 bg-blue-100 rounded-full flex items-center justify-center mb-3 xs:mb-4">
                <FaWater className="text-blue-600 text-base xs:text-lg sm:text-xl" />
              </div>
              <h3 className="text-base xs:text-lg font-bold mb-2 xs:mb-3">Water Conservation</h3>
              <p className="text-xs xs:text-sm text-gray-600">
                Our production processes are designed to minimize water usage and prevent pollution, preserving this precious resource.
              </p>
            </div>
            
            <div className="bg-white rounded-lg p-4 xs:p-5 sm:p-6 shadow-md hover:shadow-lg transition-shadow sm:col-span-2 md:col-span-1 sm:max-w-md sm:mx-auto sm:w-full">
              <div className="w-10 h-10 xs:w-12 xs:h-12 bg-green-100 rounded-full flex items-center justify-center mb-3 xs:mb-4">
                <FaRecycle className="text-green-600 text-base xs:text-lg sm:text-xl" />
              </div>
              <h3 className="text-base xs:text-lg font-bold mb-2 xs:mb-3">Reducing Waste</h3>
              <p className="text-xs xs:text-sm text-gray-600">
      ...
      <section className="py-8 xs:py-12 sm:py-16 px-4 xs:px-6 bg-white">
        <div className="container mx-auto">
          <h2 className="text-xl xs:text-2xl sm:text-3xl font-bold text-gray-800 mb-6 xs:mb-8 sm:mb-10 text-center">Visit Our Stores</h2>
          
          <div className="flex flex-col lg:flex-row items-center gap-6 xs:gap-8 sm:gap-12 mb-6 xs:mb-8 sm:mb-12">
            <div className="w-full lg:w-1/2 relative h-48 xs:h-64 sm:h-80 md:h-[400px] rounded-lg overflow-hidden shadow-xl">
              <Image 
            ...
            <div className="lg:w-1/2">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 xs:gap-5 sm:gap-6">
                <div className="border border-gray-200 rounded-lg p-3 xs:p-4">
                  <h3 className="font-bold text-base xs:text-lg mb-1 xs:mb-2">Vasai East Store</h3>
                  ...
                  <p className="text-xs xs:text-sm text-gray-600 mb-2 xs:mb-3">Mon-Sat: 10am-9pm, Sun: 11am-7pm</p>
                </div>
                
                <div className="border border-gray-200 rounded-lg p-3 xs:p-4">
                  <h3 className="font-bold text-base xs:text-lg mb-1 xs:mb-2">Vasai West Store</h3>
                ...
                <div className="border border-gray-200 rounded-lg p-3 xs:p-4">
                  <h3 className="font-bold text-base xs:text-lg mb-1 xs:mb-2">Nalasopara Store</h3>
                ...
                <div className="border border-gray-200 rounded-lg p-3 xs:p-4 flex items-center justify-center">
                  <Link 
                    href="/contact" 
                    className="text-pink-500 font-medium hover:underline flex items-center text-xs xs:text-sm sm:text-base"
                  >
                    View All Locations
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 xs:h-5 xs:w-5 ml-1" viewBox="0 0 20 20" fill="currentColor">
